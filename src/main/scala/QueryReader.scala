...
object QueryReader {
  ...
  case class QueryObject(index: String, requested: Int, processingModel: String,
                         ...
                         fbOrigWeight: Option[Double], scorer: String, queries: List[SingleQuery])
  ...
  def main(args: Array[String]): Unit = {
    val queryJson: String = "/home/tomek/TUDelft/Courses/Information Retrieval/CoreIRGroup7/queries_test.json"
